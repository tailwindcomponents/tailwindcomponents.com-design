...
<section class="container px-4 py-10 mx-auto">
    <div class="flex items-center justify-center space-x-6">
        ...
        <div>
            <h3 class="text-3xl font-semibold text-gray-800 dark:text-gray-200">Jane Doe</h3>

            <p class="mt-2 text-gray-500 dark:text-gray-400">23 Components</p>

            <div class="flex items-center mt-3 space-x-3">
                <button class="px-4 py-2 mt-2 text-sm text-gray-600 transition-colors duration-200 transform border rounded-lg dark:text-gray-200 dark:border-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
                    Settings
                </button>

                <button class="px-4 py-2 mt-2 text-gray-600 transition-colors duration-200 transform border rounded-lg dark:text-gray-200 dark:border-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
            ...
            <div class="flex items-center justify-between mt-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex flex-col space-y-1">
                        <a href="#" class="font-semibold text-gray-800 dark:text-gray-200 sm:text-lg dark:hover:text-primary hover:text-primary hover:underline">Navbar with alpinejs</a> 
                        <a href="#" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">Jane Doe</a>
                    </div>
                </div>
